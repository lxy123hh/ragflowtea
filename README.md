...
本仓库在 RAGFlow 开源框架基础上，完成了面向茶园老板的本地化 AI 知识库问答项目落地：接入 Open WebUI 管理的本地 Ollama 模型，使用 `deepseek-r1:70b` 和 `bge-m3:latest`，将甲方 3 份茶业务 Excel 资料构建为 649 个知识片段、83,456 tokens 的知识库，并完成模型代理适配、问答验收、量化优化和茶园业务 HTTP 工具调用扩展。
